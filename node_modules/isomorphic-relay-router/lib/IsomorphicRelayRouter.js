...
var IsomorphicRelayRouter = (function (_RelayRouter) {
    ...
    function IsomorphicRelayRouter() {
        ...
        return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(IsomorphicRelayRouter).apply(this, arguments));
    }

    (0, _createClass3.default)(IsomorphicRelayRouter, [{
        key: 'renderRouterContext',
        value: function renderRouterContext(props) {
...
IsomorphicRelayRouter.displayName = 'IsomorphicRelayRouter';
