...
class UserAuthSmart extends React.Component {
        ...
        return (
            ...
            >
                <div style={styles.popover}>
                    ...
                    <Divider />
                    <List>
                        <ListItem primaryText="Log in as a different user"
    ...
    render() {
        if (this.props.Viewer.User_IsAnonymous)
            return (
                <IconButton key='login' tooltip="Log In"
                            onTouchTap={ this._handle_Open_Dialog_UserNameAndPassword.bind( this ) }>
